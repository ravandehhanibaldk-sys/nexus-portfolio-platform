...
const da: Dictionary = {
  ...
  climate: {
    ...
    monthSeasonSelectorSubtitle: "Semantiske tilstande · Standard / Svæv / Valgt",
  ...
  solar: {
    ...
    legendHeading: "Signaturforklaring",
    legendReferencePath: "Referencebane",
    legendSelectedPath: "Valgt bane",
    legendNoonMarker: "Middagsmarkør",
    legendBuilding: "Bygning",
    legendShadowIndicative: "Skygge (vejledende)",
