 ...
 * Danish is an AI-drafted translation — [DANISH COPY REVIEW PENDING], see
 * Workstream 3 final report; not yet native-reviewed. `id`, `name`
...
const villaEfe: ProjectInput = {
  ...
  name: "Villa Efe",
  typology: {
    en: "Residential — Luxury Coastal Villa, New Construction",
    da: "Bolig — luksuriøs kystvilla, nybyggeri",
  },
  ...
  thesisSentence: {
    ...
    da: "Villa Efe er en luksusvilla bygget fra bunden på en stejl middelhavsgrund direkte ved vandet i Nordcypern, der organiserer fire privatlivsgraduerede niveauer — fra en underjordisk servicekælder til en tagterrasse til fritidsbrug — omkring uafbrudt havudsigt, teknisk funderet kystudgravning og et gennemgående inde-/uderumsforløb.",
  },
  ...
  differentiator: {
    ...
    da: "Platformens eneste nybyggeriprojekt fra bunden — en stor luksuriøs kystvilla på en stejl grund ved vandet med en fuld underjordisk kælder og teknisk funderet jordstøtte, organiseret som et fireniveauers privatlivshierarki — i modsætning til Villa Red Suns budgetdrevne renovering af to eksisterende bygninger.",
  },
