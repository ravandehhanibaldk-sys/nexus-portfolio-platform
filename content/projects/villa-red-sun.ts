...
Ud over spændingen mellem pris og kvalitet mellem de to ejere opstod der et praktisk problem som følge af enhedernes separate renoveringshistorik. Døre og vinduer i hele huset var i forskellig stand, forskellige størrelser og forskellige materialer, hver især renoveret uafhængigt med forskellige budgetter på forskellige tidspunkter. Et begrænset indgreb, der blot fjernede én væg, ville have skabt et større rum og imødekommet nogle af omkostningsbekymringerne, men resultatet ville have været en akavet, tunnellignende enhed — en reel risiko ved videresalg. Vejet op mod den juridiske kompleksitet ved at sammenlægge to separate skøder til ét, var det kun en ordentlig og komplet renovering — Forslag D — der reelt løste det, de to enheder havde ophobet gennem årene, i stedet for blot at gå på kompromis omkring det.

Når jeg ser tilbage, ville jeg ikke ændre den måde, jeg gennemførte sammenligningsprocessen på. Jeg brugte meget tid på den og fremlagde reel dokumentation for kunderne, især beviset omkring fundamentet, i stedet for blot at bede dem stole på en dyrere løsning. Jeg tror stadig på princippet: "Jeg stoler nok på den første idé til at kæmpe for den — men ikke nok til at holde op med at teste den." Af de to huse i denne portfolio er det Villa Red Sun, hvor denne sætning gælder tydeligst. Idéen overlevede, fordi den blev testet mod reel modstand fra kunderne og reelle beviser — ikke fordi den forblev uudfordret.`,
      },
      assets: [],
    },
  },
